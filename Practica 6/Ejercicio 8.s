; El siguiente programa implementa una animación de una pelotita rebotando por la pantalla. Modifíquelo para que en 
...
color_pelota2:  .word32 0x000000FF  ; ROJO
color_fondo:   .word32 0x00FFFFFF  ; Blanco 
        ...
        lwu    $v2, color_pelota2($0) 
        lwu    $v1, color_fondo($0) 
        daddi  $s0, $0, 23     ; Coordenada X de la pelota 1
        daddi  $s1, $0, 1      ; Coordenada Y de la pelota 1
        daddi  $s5, $0, 40     ; Coordenada X de la pelota 2
        daddi  $s6, $0, 1      ; Coordenada X de la pelota 2
